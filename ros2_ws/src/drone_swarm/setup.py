...
#         ('share/' + package_name + '/launch', ['launch/swarm_launch.py', 'launch/simple_multi_drone_launch.py']),
#         ('share/' + package_name + '/worlds', ['worlds/swarm_world.sdf', 'worlds/iris_runway.sdf']),
